...
export default {
  // === Identity ===
  name: "Scotmid",
  tokenEnv: "TOKEN_SCOTMID", // <— set this env var with your Bearer token

  // === Endpoint ===
  apiUrl: "https://scotmidcoop-wmd-dev.ri-team.com/api/v-20180601/markdown",

  // === Data source ===
  csvPath: "../dataFiles/ScotmidData.csv",
