...
function buildRequestId() {
  ...
  return `SouthernPerformanceTest-${todayAsCompact()}${suffix ? "-" + suffix : ""}`;
}
...
export default {
  // === Identity ===
  name: "Southern",
  tokenEnv: "TOKEN_SOUTHERN", // <— set this env var with your Bearer token

  // === Endpoint ===
  apiUrl: "https://scntcoop-wmd-dev.ri-team.com/api/v-20180601/markdown",

  // === Data source ===
  csvPath: "../dataFiles/SouthernData.csv",
  ...
  operations: [
    {
      ...
      url: "https://scntcoop-wmd-dev.ri-team.com/api/v-20180601/markdown",
